...
fsa2 <- bind_rows(
  ...
  `2021`=read_fsa('downloaded excel files/2021_fsa_acres_web_010322.xlsx') |> 
    track_dataset('2021') |>
    slice(-1) |>
  ...
  `2022`=read_fsa('downloaded excel files/2022_fsa_acres_web_010323.xlsx') |> track_dataset('2022') |>
    dplyr::mutate(`State County Code` = as.character(`State County Code`)),
  `2023`=read_fsa('downloaded excel files/2023_fsa_acres_web_010224.xlsx') |> track_dataset('2023') |>
    dplyr::mutate(`State County Code` = as.character(`State County Code`)),
  .id='Year')  |> track_dataset('fsa2012-2023') ## 1,790,332 obs of 16 variables. 158,999,384 bytes
```
