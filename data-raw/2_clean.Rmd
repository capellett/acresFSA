...
```
I'm not sure why the state codes appear to skip some numbers (03, for example). But everything else seems correct.
...
fsa <- dplyr::select(fsa, -`State Code`, -`State Abbrev`) %>%
